        ...
        Column(
            ...
            Row(
                ...
                Icon(
                    ...
                    contentDescription = null,
                    tint = if (safetyDeviceNumber > 0 && state.hasUnreadSafetyData) Color.Red else TextColor
                )
                Text(
                    modifier = Modifier,
                    ...
                    maxLines = 1,
                    style = MaterialTheme.typography.titleMedium,
                    color = if (safetyDeviceNumber > 0 && state.hasUnreadSafetyData) Color.Red else TextColor
                )
            }
        }
