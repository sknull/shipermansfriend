...
image::docs/screenshots/Screenshot_Driving Vessels Tab_3.png[]
...
image::docs/screenshots/Screenshot_Moored Vessels Tab_3.png[]
...
- In the top right corner you find buttons to zoom in and out and to jump back to the previous view.
- In the bottom left corner the current zoom distance of the radar is shown.
- In the bottom right corner you see counts for visible vessels on the radar and currently active safety messages (those will be colored red when there are unread messages)

image::docs/screenshots/Screenshot_Radar Page_4.png[]
...
image::docs/screenshots/Screenshot_Radar Page_CategoriesFilter.png[]
