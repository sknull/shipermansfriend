...
When critical messages arrive which contain words like "warning", "alert", etc. the
messages are also highlighted in red.

image::docs/screenshots/Screenshot_Safety Tab.png[]
...
image::docs/screenshots/Screenshot_Search Tab_2.png[]
